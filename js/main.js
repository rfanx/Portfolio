...
const projectData = [
  {
    title: "DC.com",
    subTitle:
      "A clone of the DC website",
    thumbnail: "./img/git-pic.png",
    description:
      "This is a clone of the DC website that I made to sharpen my HTML and CSS skills.",
    techStack: ["HTML", "CSS"],
    srcURL: "https://rfanx.github.io/Dc-clone/",
  },
  {
    title: "Ajanta",
    subTitle:
      "A clone of the Ajanta Toothbrush website.",
    thumbnail: "./img/ajanta-pic.png",
    description:
      "This is a clone of the Ajanta website that I made to sharpen my HTML and CSS skills.",
    techStack: ["HTML", "CSS"],
    srcURL: "https://rfanx.github.io/Ajanta-toothbrush/",
  },
  {
    title: "Starbucks",
    subTitle:
      "A clone of the Starbucks website.",
    thumbnail: "./img/starbucks.png",
    description:
      "This is a clone of the  website that I made to sharpen my HTML,CSS and Bootstrap skills.I made this website responsive using Bootstrap. ",
    techStack: ["HTML", "CSS","Bootstrap"],
    srcURL: "https://rfanx.github.io/starbucks-responsive/",
  },
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/rfanx" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
...
async function getRepoList() {
  try {
    const response = await fetch(
      "https://github.com/rfanx?tab=repositories"
    );
